...
The Data Source 1 is `apisrat`, which is a sample stratified by type of school (Elementary/Middle/High School), and the Data Source 2 is `apiclus1`, which is a cluster sample of school districts.Our goal is to estimate 
...
###Step 1:Simulating draws of the strata control totals from the referenced data source
...
The final point estimate is the average of intermediate calibrations, and the standard deviaiton will be returned as well.
...
### Using Raking tool on marginal totals
```{r raking example}
